...
export const GlobalFontStyle = createGlobalStyle`
  @font-face {
    ...
    src: url('${eot}?t=1528610804703'); /* IE9*/
    src: url('${eot}?t=1528610804703#iefix') format('embedded-opentype'), /* IE6-IE8 */
    ...
    url('${ttf}?t=1528610804703') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+*/
    url('${svg}?t=1528610804703#iconfont') format('svg'); /* iOS 4.1- */
  }
